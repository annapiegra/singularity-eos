...
int main(int argc, char* argv[]) {
  ...
  int nFine = argc >= 4 ? std::atoi(argv[3]) : 512;
  ...
  */
  ...
  for (int i = 0; i < matids.size(); i++) {
    ...
    std::cout << "\t\tInterpolate pressure of rho T" << std::endl;
    {
	  ...
	  myfileE << xVals(j,0)<<"  "<<yVals(0,i)<<"  "<< pressEOSPAC(j,i)  << std::endl;
	  myfileS << xVals(j,0)<<"  "<<yVals(0,i)<<"  "<< pressSpiner_h(j,i)  << std::endl;
    ...
    {      
      ...
      std::ostringstream fileNameStreamS1;
      fileNameStreamS1 << "/home/annap/singularity-eos/myTests/tempSpiner_h_" << matid << ".out";
      std::ofstream myfileS1 (fileNameStreamS1.str());
      std::ostringstream fileNameStreamS2;
	  ...
	  myfileS1 << xVals(j,0)<<"  "<< yVals(0,i)<<"  "<< tempSpiner_h(j,i)  << std::endl;
	  myfileS2 << xVals(j,0)<<"  "<< yVals(0,i)<<"  "<< tempSpinerE_h(j,i) << std::endl;
	  myfileEe << xVals(j,0)<<"  "<< yVals(0,i)<<"  "<< tempEOSPAC(j,i) << std::endl;
